...
public class PostsRepositoryTest {
    ...
    public void 게시글저장_불러오기(){
        ...
        String content = "안녕본문~안녕안녕!";

        postsRepository.save(Posts.builder().title(title).content(content).author("SexySOO").build());
        //when
        ...
        Assertions.assertThat(posts.getAuthor()).isEqualTo("SexySOO");
    }
